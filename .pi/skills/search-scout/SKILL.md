...
curl -s -H "Authorization: Bearer $SCOUT_API_KEY" \
  "https://192.168.40.163:8741/v1/spaces/scout/symbols?path_prefix=src/"
```
...
```bash
curl -s -H "Authorization: Bearer $SCOUT_API_KEY" \
  "https://192.168.40.163:8741/v1/spaces/scout/file?rel_path=src/auth.py&start_line=1&end_line=40"
```
...
curl -s -X POST "https://192.168.40.163:8741/v1/spaces/scout/search" \
